...
Abstract:
    ...
    Browser Monitor: derived from microsoft/Windows-driver-samples video/IndirectDisplay (commit 97429c5). Reduced to a
...
{
    // EDID 1.4 "BrowserMon" (vendor BMV): one CTA-861 1920x1080@60 detailed timing (148.5 MHz), 527x296 mm, sRGB
    {
        {
            0x00,0xFF,0xFF,0xFF,0xFF,0xFF,0xFF,0x00,0x09,0xB6,0x01,0x00,0x01,0x00,0x00,0x00,0x00,0x2E,0x01,
            0x04,0xA0,0x34,0x1D,0x78,0x06,0xEE,0x91,0xA3,0x54,0x4C,0x99,0x26,0x0F,0x50,0x54,0x00,0x00,0x00,
            0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x01,0x02,0x3A,0x80,
            0x18,0x71,0x38,0x2D,0x40,0x58,0x2C,0x45,0x00,0x0F,0x28,0x21,0x00,0x00,0x1E,0x00,0x00,0x00,0xFD,
            0x00,0x3B,0x3D,0x42,0x45,0x0F,0x01,0x0A,0x20,0x20,0x20,0x20,0x20,0x20,0x00,0x00,0x00,0xFC,0x00,
            0x42,0x72,0x6F,0x77,0x73,0x65,0x72,0x4D,0x6F,0x6E,0x0A,0x20,0x20,0x00,0x00,0x00,0x10,0x00,0x00,
...
void IndirectDeviceContext::InitAdapter()
{
    ...
    AdapterCaps.EndPointDiagnostics.pEndPointFriendlyName = L"Browser Monitor Virtual Display";
    AdapterCaps.EndPointDiagnostics.pEndPointManufacturerName = L"Browser Monitor";
    AdapterCaps.EndPointDiagnostics.pEndPointModelName = L"BrowserMonitorIdd";
